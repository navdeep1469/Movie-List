      ...
      <Card.Body>
        <div className="row">
          ...
          <div className="col-sm-2">
            <Button
              onClick={() => {
                removeFavourite(props.movie.movieId);
              }}
    ...
    <div className="container-fluid movie-page">
      <div className="container-fluid favourite">
        {favouriteMovies.map((currentMovie) => (
          <Movie movie={currentMovie} key={currentMovie._id} />
        ))}
        {favouriteMovies.length <= 0 && (
          <h4>There are no favourites...Please go back and favourite the best ones</h4>
        )}
      </div>
    </div>
  );
